...
function App() {
   ...
   return (
      <div className="flex flex-col font-YekanBakh bg-gradient-to-r from-pink-750 to-amber-350">
         <nav className="z-20 border-b shadow bg-gray-50">
            <div className="container flex justify-between px-4 py-2 mx-auto">
               <div className="block md:flex md:flex-1 md:justify-between">
                  {/*className="flex flex-col md:flex-row md:flex-1 md:justify-between" */}
                  <a href="#" id="right" className="flex items-center">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-gray-700 size-6 md:size-7">
                        <path
                           strokeLinecap="round"
                     ...
                     <h2 className="mr-3 text-xl font-semibold text-gray-600 md:font-bold md:text-4xl text-nowrap">سایت پاورکرن</h2>
                  </a>

                  <div id="left_Or_buttom" className={`md:flex md:flex-row ${showMenu ? "flex" : "hidden"} flex-col items-center text-gray-500 space-y-2 md:space-y-0 mt-2 md:mt-0 md:space-x-3 space-x-reverse`}>
                     <a href="#" className="text-lg md:text-xl md:p-3 hover:text-gray-950">
                        فعال
                     </a>
                     <a href="#" className="text-lg md:text-xl md:p-3 hover:text-gray-950">
                        لینک
                     ...
                     <a href="#" className="px-3 py-1 text-base bg-gray-700 text-white rounded-full duration-300 opacity-[.8] ease-in-out hover:scale-110">
                        لینک فعال
                     </a>
                  </div>
               </div>

               <div id="Res-menu" className={`md:hidden flex ${showMenu ? "items-start" : "items-center"} `}>
                  <button type="button" onClick={() => setShowMenu(!showMenu)}>
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 hover:text-pink-600">
         ...
         {/* bakhsh 1 */}
         <main className="z-10">
            <div className="container flex flex-col px-8 pt-12 mx-auto md:pt-24 md:flex-row">
               <div className="flex flex-col items-center justify-center flex-1 md:pl-4 xl:pl-2 md:items-start text-gray-50">
                  <span className="text-lg md:text-xl">بیزینس شما چیست؟</span>
                  <h2 className="my-6 text-3xl font-bold leading-tight text-center md:text-right lg:text-5xl xl:text-6xl">پیام اصلی شما برای فروش محصول</h2>
                  <p className="text-lg font-medium text-center md:text-right md:text-xl">متن پایینی شما نباید بلند باشد و نباید کوتاه بلکه باید درست باشد</p>
                  <button className="inline-block p-4 px-8 my-5 font-bold text-gray-600 duration-200 ease-in-out rounded-full shadow-md md:mt-10 bg-gray-50 hover:scale-105">دنبال کردن</button>
               </div>
               <div className="flex-1">
                  <img className="md:scale-[1.15]" src="../public/Images/hero.png" alt="hero" />
               </div>
            </div>
            <svg viewBox="0 0 1428 174" className="md:-mt-9" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
         ...
         <section className="bg-white border-b shadow-md">
            <div className="container flex flex-col max-w-5xl px-8 pt-10 pb-8 mx-auto md:pb-16">
               {/*b2 title */}
               <div className="flex flex-col items-center mb-10">
                  <h3 className="mb-1 text-3xl font-semibold text-gray-800 md:mb-2 md:text-4xl">عنوان</h3>
                  <div className="h-1 rounded-t-full opacity-50 w-52 md:w-64 bg-gradient-to-r from-pink-750 to-amber-350"></div>
               </div>

               {/*b2 sec1 */}
               <div className="flex flex-col text-center md:text-right md:flex-row">
                  <div className="flex-1">
                     <h3 className="text-2xl font-semibold text-gray-800 md:text-3xl">لورم ایپسوم متن ساختگی</h3>
                     <p className="max-w-md mt-2 text-gray-500 md:text-lg">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است.</p>
                  </div>
                  <div className="flex justify-center flex-1">
                     <svg className="w-4/5 md:w-5/6" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                           ...
                           stroke-width="4"
                        ></path>
                        <path transform="translate(-11.5 -150.75)" d="M81,599.39a14,14,0,0,1,7-11.5l3.14,6.22-.1-7.53a14.22,14.22,0,0,1,4.63-.56A14,14,0,1,1,81,599.39Z" fill="#57b894"></path>
                        <path transform="translate(-11.5 -150.75)" d="M106,694.38a14,14,0,1,0-.68-11.3l8.77,7.13L104.46,688A14,14,0,0,0,106,694.38Z" fill="#57b894"></path>
                        <path
                           transform="translate(-11.5 -150.75)"
                        ...
                        <path
                           ...
                           opacity=".1"
                        ></path>
                        <path transform="translate(-11.5 -150.75)" d="m141.07 715.07s-11.08-0.34-14.42-2.72-17-5.21-17.86-1.4-16.65 19-4.15 19.06 29.06-1.94 32.4-4 4.03-10.94 4.03-10.94z" fill="#656380"></path>
                        <path
                           transform="translate(-11.5 -150.75)"
                        ...
                        <path d="m172 133.75h268v434h-247.58a20.42 20.42 0 0 1 -20.42 -20.42v-413.58z" fill="#ff6347"></path>
                        <path transform="translate(-11.5 -150.75)" d="M1017,282.42V294H183V282.42A20.42,20.42,0,0,1,203.42,262H996.58A20.42,20.42,0,0,1,1017,282.42Z" fill="#3f3d56"></path>
                        ...
                        <path transform="translate(-11.5 -150.75)" d="M387.5,490A66.5,66.5,0,1,1,321,423.5,66.47,66.47,0,0,1,387.5,490Z" fill="none" stroke="#f2f2f2" stroke-miterlimit="10" stroke-width="2"></path>
                        <path
                           transform="translate(-11.5 -150.75)"
                        ...
                        <path
                           ...
                           stroke-width="2"
                        ></path>
                        <path transform="translate(-11.5 -150.75)" d="M337.5,452.5a15,15,0,0,1-12.12,14.73l-15-23.51a15,15,0,0,1,27.16,8.78Z" fill="none" stroke="#f2f2f2" stroke-miterlimit="10" stroke-width="2"></path>
                        <path transform="translate(-11.5 -150.75)" d="m347.5 481.5" fill="none" stroke="#f2f2f2" stroke-miterlimit="10" stroke-width="2"></path>
                        <path transform="translate(-11.5 -150.75)" d="m333.5 480.5" fill="none" stroke="#f2f2f2" stroke-miterlimit="10" stroke-width="2"></path>
                        <path
                           transform="translate(-11.5 -150.75)"
                        ...
                        <path transform="translate(-11.5 -150.75)" d="m978.18 606.93l-1.73 2s-21.05 2-20.2 5.39 25.35-4.55 25.35-4.55z" fill="#ffc1c7"></path>
                        <path transform="translate(-11.5 -150.75)" d="m1016.3 605.22s-22.5 8-34.74 4.56l5.69 11.39s29.05-0.86 34.18-6-5.13-9.95-5.13-9.95z" fill="#ff6584"></path>
                        <path transform="translate(-11.5 -150.75)" d="m1016.3 605.22s-22.5 8-34.74 4.56l5.69 11.39s29.05-0.86 34.18-6-5.13-9.95-5.13-9.95z" opacity=".1"></path>
                        ...
                        <path
                           ...
                           fill="#ff6584"
                        ></path>
                        <path transform="translate(-11.5 -150.75)" d="m1001.2 553.67h-10.54s-6.27 7.12-7.12 25.06l-3.42 14.27s-7.12 17.09-2.85 19.94 12.54 2.56 14.24-3.13 13.44-38.76 13.44-38.76z" fill="#ff6584"></path>
                        <path
                           transform="translate(-11.5 -150.75)"
               ...
               {/*b2 sec2 */}
               <div className="flex flex-col-reverse mt-24 md:flex-row">
                  <div className="flex justify-center flex-1 md:justify-start">
                     <svg className="w-9/12 md:w-5/6" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="flex-1 mb-6 text-center md:mb-0 md:text-right">
                     <h3 className="text-2xl font-semibold text-gray-800 md:text-3xl">لورم ایپسوم متن ساختگی</h3>
                     <p className="max-w-md mt-2 text-gray-500 md:text-lg">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است.</p>
                  </div>
               </div>
         ...
         <section className="bg-white border-b shadow">
            <div className="container mx-auto my-10">
               <div className="flex flex-col items-center mb-10">
                  <h3 className="mb-1 text-3xl font-semibold text-gray-800 md:mb-2 md:text-4xl">عنوان</h3>
                  <div className="h-1 rounded-t-full opacity-25 w-52 md:w-64 bg-gradient-to-r from-pink-750 to-amber-350"></div>
               </div>
               <div className="flex flex-col justify-center px-5 space-y-7 md:space-x-reverse md:space-y-0 md:space-x-4 md:flex-row">
                  {/* b3 card1 */}
                  <div className="flex flex-col max-w-md px-8 py-8 bg-white border-b shadow md:px-12">
                     <p className="text-gray-500">لورم اپیسوم متن ساختگی</p>
                     <h3 className="mt-0.5 text-2xl font-semibold text-gray-800">لورم اپیسوم متن ساختگی</h3>
                     <p className="mt-2 leading-relaxed text-gray-700 md:mt-3">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است.</p>

                     <a href="#" className="self-end px-5 py-2 mt-4 text-lg bg-gray-700 text-white rounded-full duration-300 opacity-[.8] ease-in-out hover:scale-110">
                        لینک
                     </a>
                  </div>
                  {/* b3 card2 */}
                  <div className="flex flex-col max-w-md px-8 py-8 bg-white border-b shadow md:px-12">
                     <p className="text-gray-500">لورم اپیسوم متن ساختگی</p>
                     <h3 className="mt-0.5 text-2xl font-semibold text-gray-800">لورم اپیسوم متن ساختگی</h3>
                     <p className="mt-3 leading-relaxed text-gray-700">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است.</p>
         ...
         <section className="bg-gray-50">
            <div className="container mx-auto mt-12 mb-28">
               <div className="flex flex-col items-center mb-10">
                  <h3 className="mb-1 text-3xl font-semibold text-gray-800 md:mb-2 md:text-4xl">قیمت ها</h3>
                  <div className="h-1 rounded-t-full opacity-25 w-52 md:w-64 bg-gradient-to-r from-pink-750 to-amber-350"></div>
               </div>

               {/* grid grid-cols-1 justify-items-center gap-y-5 md:gap-y-0 md:grid-cols-3 place-items-end */}
               <div className="flex flex-col items-center justify-center px-2 space-y-5 lg:px-10 md:space-y-0 md:items-end md:flex-row">
                  {/* b4 qeymat 1 */}
                  <div className="w-5/6 bg-white border-b shadow md:w-full lg:w-5/6 md:justify-self-end">
                     <div className="py-6 text-center border-b-4">
                        <h3 className="text-2xl font-semibold text-gray-700">رایگان</h3>
                     </div>
                     <ul className="grid grid-cols-1 text-center text-gray-600">
                        <li className="py-3 border-b">ویژگی</li>
                        <li className="py-3 border-b">ویژگی</li>
                        <li className="py-3 border-b">ویژگی</li>
                     </ul>
                     <div className="flex flex-col pt-3 mt-16">
                        <div className="flex items-center justify-center">
                           <span className="text-2xl font-semibold">0 تومان</span>
                           <span className="mt-1.5 mr-1">برای یک کاربر</span>
                        </div>
                        <a href="#" className="self-center px-5 py-1.5 mt-6 mb-5 text-lg bg-gray-700 text-white rounded-full duration-300 opacity-[.8] ease-in-out hover:scale-110">
                           عضویت
                        </a>
                     </div>
                  </div>
                  {/* b4 qeymat 2 */}
                  <div className="z-10 w-5/6 bg-white border-b shadow md:shadow-xl md:w-full">
                     <div className="py-6 text-center ">
                        <h3 className="text-2xl font-semibold text-gray-950">پایه</h3>
                     </div>
                     <div className="w-full h-1 bg-gradient-to-r from-pink-750 to-amber-350"></div>

                     <ul className="grid grid-cols-1 font-medium text-center text-gray-700">
                        <li className="py-3 border-b">ویژگی</li>
                        <li className="py-3 border-b">ویژگی</li>
                        <li className="py-3 border-b">ویژگی</li>
                        <li className="py-3 border-b">ویژگی</li>
                     ...
                     <div className="flex flex-col pt-3 mt-10">
                        <div className="flex items-center justify-center">
                           <span className="text-2xl font-semibold">20 هزار تومان</span>
                           <span className="mt-1.5 mr-1">/ به ازای هر کاربر</span>
                        </div>
                        <a href="#" className="self-center px-5 py-1.5 mt-6 mb-5 text-lg bg-gray-700 text-white rounded-full duration-300 opacity-[.8] ease-in-out hover:scale-110">
                           عضویت
                        </a>
                  ...
                  {/* b4 qeymat 3 */}
                  <div className="w-5/6 bg-white border-b shadow md:w-full lg:w-5/6 md:justify-self-start">
                     <div className="py-6 text-center border-b-4">
                        <h3 className="text-2xl font-semibold text-gray-700">حرفه ای</h3>
                     </div>
                     <ul className="grid grid-cols-1 text-center text-gray-600">
                        <li className="py-3 border-b">ویژگی</li>
                        <li className="py-3 border-b">ویژگی</li>
                     ...
                     <div className="flex flex-col pt-3 mt-16">
                        <div className="flex items-center justify-center">
                           <span className="text-2xl font-semibold">40 هزار تومان</span>
                           <span className="mt-1.5 mr-1">/ به ازای هر کاربر</span>
                        </div>
                        <a href="#" className="self-center px-5 py-1.5 mt-6 mb-5 text-lg bg-gray-700 text-white rounded-full duration-300 opacity-[.8] ease-in-out hover:scale-110">
                           عضویت
         ...
         {/* bakhsh 5 */}
         <section>
            <svg viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
               <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
            ...
            <div className="container mx-auto py-28">
               <div className="flex flex-col items-center text-center">
                  <h3 className="text-5xl font-bold leading-snug tracking-wide text-white lead">فراخوانی برای اقدام</h3>
                  <div className="h-1 mt-1.5 mb-4 bg-gray-200 rounded-t-full w-60 opacity-45"></div>
                  <p className="text-2xl font-medium text-white">این پیام برای شما تا اقدام کنید</p>
                  <button className="inline-block px-8 py-4 mt-10 font-bold text-gray-600 duration-200 ease-in-out rounded-full shadow-md bg-gray-50 hover:scale-105">دکمه!</button>
               </div>
            </div>
         </section>
         ...
         <footer className="bg-gray-50">
            <div className="container px-8 mx-auto">
               <div className="grid grid-cols-1 py-5 md:py-10 md:grid-cols-5 gap-y-6">
                  {/* logo col */}
                  <div className="flex text-pink-700">
                     ...
                     <h2 className="mr-2 text-2xl font-bold">پاور کورن</h2>
                  </div>

                  {/* col 1 */}
                  <div className="flex flex-row md:flex-col">
                     <span className="text-gray-500">لینک ها</span>
                     <ul className="flex flex-row mr-4 space-x-4 space-x-reverse md:flex-col md:space-x-0 md:mr-0 md:mt-4 md:space-y-2 text-gray-950">
                        <li className="hover:text-pink-700 hover:underline">
                  ...
                  {/* col 2 */}
                  <div className="flex flex-row md:flex-col">
                     <span className="text-gray-500">قوانین</span>
                     <ul className="flex flex-row mr-4 space-x-4 space-x-reverse md:flex-col md:space-x-0 md:mr-0 md:mt-4 md:space-y-2 text-gray-950">
                        <li className="hover:text-pink-700 hover:underline">
                           <a href="#">شرایط</a>
                        </li>
                  ...
                  {/* col 3 */}
                  <div className="flex flex-row md:flex-col">
                     <span className="text-gray-500">شبکه های اجتماعی</span>
                     <ul className="flex flex-row mr-4 space-x-4 space-x-reverse md:flex-col md:space-x-0 md:mr-0 md:mt-4 md:space-y-2 text-gray-950">
                        <li className="hover:text-pink-700 hover:underline">
                           <a href="#">اینستاگرام</a>
                        </li>
                  ...
                  {/* col 4 */}
                  <div className="flex flex-row md:flex-col">
                     <span className="text-gray-500">درباره شرکت</span>
                     <ul className="flex flex-row mr-4 space-x-4 space-x-reverse md:flex-col md:space-x-0 md:mr-0 md:mt-4 md:space-y-2 text-gray-950">
                        <li className="hover:text-pink-700 hover:underline">
                           <a href="#">بلاگ</a>
                        </li>
